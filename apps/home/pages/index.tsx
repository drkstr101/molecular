...
/*
  This page requires Tailwind CSS v3.0+
...
export default function Greeting(props: GreetingProps) {
  return (
    <div className="relative py-16 overflow-hidden bg-base-300">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="mx-auto text-lg max-w-prose">
          <h1>
            <span className="block font-semibold tracking-wide text-center uppercase text-primary-content">
              Introducing
            </span>
            <span className="block mt-2 text-3xl font-extrabold leading-8 tracking-tight text-center text-base-content sm:text-4xl">
              Hello, World!
            </span>
          </h1>
          <p className="mt-8 text-xl leading-8 text-neutral-content">
        ...
        <div className="mx-auto mt-6 prose prose-lg text-neutral-content prose-indigo">
          <p>
